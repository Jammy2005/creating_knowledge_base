...
DOCS = [
    ...
    # ── شركات الاستثمار (Investment Companies) — Part 1: 16 docs ─────────────
    # URLs from: cbk.gov.kw/ar/supervision/cbk-regulations-and-instructions/instructions-for-investment-companies
    ("المقدمة — التعليمات الرقابية على شركات الاستثمار",
     BASE + "invintro-112513_v20_tcm11-112513.pdf", "شركات الاستثمار"),
    ("فهرس الجزء الأول — شركات الاستثمار",
     BASE + "invindex1-112511_v20_tcm11-112511.pdf", "شركات الاستثمار"),
    ("1. البيانات والإحصاءات التي تقدمها شركات الاستثمار إلى بنك الكويت المركزي بشكل دوري",
     BASE + "1p1-112495_v20_tcm11-112495.pdf", "شركات الاستثمار"),
    ("2. إدارة المحافظ وتسويق وحدات الصناديق — شركات الاستثمار",
     BASE + "2p1-112497_v20_tcm11-112497.pdf", "شركات الاستثمار"),
    ("3. الأسس والضوابط الخاصة بشراء شركات الاستثمار لأسهمها",
     BASE + "3p1-112498_v20_tcm11-112498.pdf", "شركات الاستثمار"),
    ("4. التعليمات الصادرة من البنك المركزي بشأن غسيل الأموال — شركات الاستثمار",
     BASE + "4p1-112499_v20_tcm11-112499.pdf", "شركات الاستثمار"),
    ("5. تعليمات بشأن ترشيد وتنظيم السياسة الائتمانية لدى شركات الاستثمار التقليدية",
     BASE + "5p1-112500_v20_tcm11-112500.pdf", "شركات الاستثمار"),
    ("6. الحدود القصوى للتركز الائتماني — شركات الاستثمار التقليدية",
     BASE + "6p1-112502_v20_tcm11-112502.pdf", "شركات الاستثمار"),
    ("7. قواعد وأسس منح شركات الاستثمار للقروض الاستهلاكية وغيرها من القروض المقسطة",
     BASE + "7p1-112503_v20_tcm11-112503.pdf", "شركات الاستثمار"),
    ("9. نظام مركزية المخاطر — شركات الاستثمار التقليدية",
     BASE + "9p1-112504_v20_tcm11-112504.pdf", "شركات الاستثمار"),
    ("10. تعليمات بشأن مراقبي الحسابات — شركات الاستثمار",
     BASE + "10p1-112505_v20_tcm11-112505.pdf", "شركات الاستثمار"),
    ("12. تعليمات بشأن عرض نتائج التفتيش على مجلس إدارة شركات الاستثمار",
     BASE + "12p1-112506_v20_tcm11-112506.pdf", "شركات الاستثمار"),
    ("13. تعليمات بشأن إحاطة بنك الكويت المركزي قبل الاتصال بسلطات رقابية أجنبية — شركات الاستثمار",
     BASE + "13p1-112507_v20_tcm11-112507.pdf", "شركات الاستثمار"),
    ("14. نظم الرقابة الداخلية — شركات الاستثمار",
     BASE + "14p1-112508_v20_tcm11-112508.pdf", "شركات الاستثمار"),
    ("15. تعميم بشأن الحصول على موافقة مسبقة من بنك الكويت المركزي على تعديلات النظام الأساسي",
     BASE + "15p1-112509_v20_tcm11-112509.pdf", "شركات الاستثمار"),
    ("17. تعليمات بشأن نسبة العمالة الوطنية في شركات الاستثمار",
     BASE + "17p1-112510_v20_tcm11-112510.pdf", "شركات الاستثمار"),
    ("19. تعليمات تنظيم أعمال الدفع الإلكتروني — شركات الاستثمار",
     BASE + "19p1-142638_v20_tcm11-142638.pdf", "شركات الاستثمار"),
    # Part 2
    ("فهرس الجزء الثاني — شركات الاستثمار",
     BASE + "invindex2-112512_v20_tcm11-112512.pdf", "شركات الاستثمار"),
    ("1. تعليمات بشأن أعضاء هيئة الرقابة الشرعية — شركات الاستثمار الإسلامية",
     BASE + "1p2-112496_v20_tcm11-112496.pdf", "شركات الاستثمار"),
    ("5. الحدود القصوى للتركز التمويلي — شركات الاستثمار الإسلامية",
     BASE + "5p2-112501_v20_tcm11-112501.pdf", "شركات الاستثمار"),

    # ── شركات المعلومات الائتمانية (Credit Information Companies) — 6 docs ────
    # URLs from: cbk.gov.kw/ar/supervision/cbk-regulations-and-instructions/Instructions-for-Credit-Information-Companies
    ("الباب الأول — القانون رقم 9 لسنة 2019 بشأن تنظيم تبادل المعلومات الائتمانية",
     BASE + "chap1-part1-154208_v20_tcm11-154208.pdf", "شركات المعلومات الائتمانية"),
    ("الباب الأول — القرار الوزاري رقم 36 لسنة 2019 بإصدار اللائحة التنفيذية لقانون المعلومات الائتمانية",
     BASE + "chap1-part2-154209_v20_tcm11-154209.pdf", "شركات المعلومات الائتمانية"),
    ("الباب الثاني — لائحة بنظام سجل شركات المعلومات الائتمانية لدى بنك الكويت المركزي",
     BASE + "chap2-part1-154210_v10_tcm11-154210.pdf", "شركات المعلومات الائتمانية"),
    ("الباب الثالث — القواعد والضوابط الخاصة بالخبرة المطلوبة لشركات المعلومات الائتمانية",
     BASE + "chap3-part1-154211_v10_tcm11-154211.pdf", "شركات المعلومات الائتمانية"),
    ("الباب الثالث — قواعد ونظم الحوكمة لشركات المعلومات الائتمانية",
     BASE + "chap3-part2-168989_v10_tcm11-168989.pdf", "شركات المعلومات الائتمانية"),

    # ── أعمال الدفع الإلكتروني (E-Payment Services) — 3 docs ─────────────────
    # URLs from: cbk.gov.kw/ar/supervision/cbk-regulations-and-instructions/regulatory-instructions-e-Payment-services
    ("الباب الأول — تعميم تعليمات تنظيم أعمال الدفع الإلكتروني للأموال 2018",
     BASE + "1chap1-epay-144306_v30_tcm11-144306.pdf", "أعمال الدفع الإلكتروني"),
    ("الباب الأول — تعميم تعليمات تنظيم أعمال الدفع الإلكتروني ووكلائهم 2023",
     BASE + "2chap1-epay-161855_v50_tcm11-161855.pdf", "أعمال الدفع الإلكتروني"),
    ("الباب الثاني — تعاميم بشأن تنظيم أعمال الدفع الإلكتروني — الضوابط الإشرافية",
     BASE + "epayment-chap2-152798_v260_tcm11-152798.pdf", "أعمال الدفع الإلكتروني"),
]
